...
class Tester(object):
    ...
    def __init__(self, model = None, data_loader = None, use_gpu = True):
        ...
        self.lib.getTestLinkMRRraw.argtypes = [ctypes.c_int64]
        self.lib.getTestLinkMRraw.argtypes = [ctypes.c_int64]
        self.lib.getTestLinkHit10raw.argtypes = [ctypes.c_int64]
        self.lib.getTestLinkHit3raw.argtypes = [ctypes.c_int64]
        self.lib.getTestLinkHit1raw.argtypes = [ctypes.c_int64]
        ...
        self.lib.getTestLinkMRRraw.restype = ctypes.c_float
        self.lib.getTestLinkMRraw.restype = ctypes.c_float
        self.lib.getTestLinkHit10raw.restype = ctypes.c_float
        self.lib.getTestLinkHit3raw.restype = ctypes.c_float
        self.lib.getTestLinkHit1raw.restype = ctypes.c_float
    ...
    def run_link_prediction(self, type_constrain = False):
        ...
        mrr_raw = self.lib.getTestLinkMRRraw(type_constrain)
        mr_raw = self.lib.getTestLinkMRraw(type_constrain)
        hit10_raw = self.lib.getTestLinkHit10raw(type_constrain)
        hit3_raw = self.lib.getTestLinkHit3raw(type_constrain)
        hit1_raw = self.lib.getTestLinkHit1raw(type_constrain)
        return mrr, mr, hit10, hit3, hit1, mrr_raw, mr_raw, hit10_raw, hit3_raw, hit1_raw
