...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='Train TransD')
    ...
    parser.add_argument('--model', type=str, default='TransD')
    ...
    # test the model
    transd.load_checkpoint('./checkpoint/transd'+args.exp+'.ckpt')
